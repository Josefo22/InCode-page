import { FaPhoneAlt, FaEnvelope, FaRegHandshake, FaClipboardList, FaLaptopCode } from 'react-icons/fa'; // Íconos para contacto
    ...
    <div className="space-y-12">
      ...
      <section className="space-y-8">
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 text-center">
          <FaClipboardList className="inline-block text-blue-600 dark:text-blue-400" size={30} />
      ...
      <section className="space-y-8">
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 text-center">
          <FaLaptopCode className="inline-block text-yellow-600 dark:text-yellow-400" size={30} />
          Experiencia Personalizada y a la Medida
        </h2>
        <p className="text-lg text-gray-700 dark:text-gray-300 text-center">
          Nos aseguramos de entender tus necesidades específicas para ofrecerte una solución web completamente personalizada.
        </p>
      </section>
      ...
      <section className="space-y-8">
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 text-center">
          <FaLaptopCode className="inline-block text-green-600 dark:text-green-400" size={30} />
          Uso de las Últimas Tecnologías y Tendencias
        </h2>
        <p className="text-lg text-gray-700 dark:text-gray-300 text-center">
          Nos mantenemos al día con las últimas tendencias en diseño y tecnología web para asegurarnos de que tu sitio no solo sea atractivo y moderno, sino también funcional y seguro.
        </p>
      </section>
      ...
      <section className="space-y-8">
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 text-center">
          <FaRegHandshake className="inline-block text-teal-600 dark:text-teal-400" size={30} />
          Relación Calidad-Precio Inmejorable
        </h2>
        <p className="text-lg text-gray-700 dark:text-gray-300 text-center">
          Creemos en ofrecer servicios de alta calidad a precios competitivos. Nuestra misión es proporcionarte una solución web que combine diseño, funcionalidad y accesibilidad económica, asegurando que obtengas el mejor valor por tu inversión.
        </p>
      </section>
      ...
      <section className="space-y-8">
        ...
        <form className="max-w-4xl mx-auto space-y-6 bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label htmlFor="phone" className="block text-lg font-medium text-gray-700 dark:text-gray-300">
                Teléfono *
              </label>
              <input
                type="tel"
...
<section className="space-y-6 text-center px-4 sm:px-6 lg:px-8">
  ...
  <div className="flex flex-wrap justify-center gap-6">
    <div className="flex items-center gap-3">
      <FaPhoneAlt size={28} className="text-blue-600 dark:text-blue-400" />
      <span className="text-lg text-gray-700 dark:text-gray-300">+57 3022891396</span>
    </div>
    <div className="flex items-center gap-3">
      <FaEnvelope size={28} className="text-blue-600 dark:text-blue-400" />
      <span className="text-lg text-gray-700 dark:text-gray-300">incoder222@gmail.com</span>
    </div>
    <div className="flex items-center gap-3">
      <FaRegHandshake size={28} className="text-blue-600 dark:text-blue-400" />
      <span className="text-lg text-gray-700 dark:text-gray-300">¡Hablemos!</span>
    </div>
  </div>
</section>
